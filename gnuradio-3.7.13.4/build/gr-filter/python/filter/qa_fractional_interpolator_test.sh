...
export srcdir=/home/udooer/Downloads/gnuradio-3.7.13.4/gr-filter/python/filter
export GR_CONF_CONTROLPORT_ON=False
export PATH=/home/udooer/Downloads/gnuradio-3.7.13.4/build/gr-filter/python/filter:$PATH
...
/usr/bin/python2 -B /home/udooer/Downloads/gnuradio-3.7.13.4/gr-filter/python/filter/qa_fractional_interpolator.py 
